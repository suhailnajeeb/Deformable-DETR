...
from test_utils import load_model_from_ckp, country_shorthands
import os
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('Deformable DETR country-wise evaluation script', parents=[get_args_parser()])
