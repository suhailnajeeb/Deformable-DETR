...
def main(args):
    ...
    output_dir.mkdir(parents=True, exist_ok=True)                               # check added
    if args.resume:
    ...
    #for epoch in range(args.start_epoch, args.epochs):      # This can be used if you want to start from epoch 0
